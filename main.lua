...
set_callback(function()
    options.trap_max = 3.2
    options.trap_min = 1.5
    options.enemy_max = 10
    options.enemy_min = 3.5
    options.enemy_curse_chance = 5
...
set_callback(function()
    if options.enemy_max<40 then
	options.enemy_max=options.enemy_max+3
    end
    if options.enemy_min<15 then
	options.enemy_min=options.enemy_min+1.5
    end
    if options.trap_max<20 then
	options.trap_max=options.trap_max+2
    end
    if options.trap_min<10 then
	options.trap_min=options.trap_min+1
    end
    if options.enemy_curse_chance<35 then
	options.enemy_curse_chance=options.enemy_curse_chance+4
    end
    if state.screen ~= SCREEN.LEVEL then return end
